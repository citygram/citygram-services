...
opts = {
  path: '/nyc-311-housing-and-development-complaints',
  ...
  source: 'http://data.cityofnewyork.us/resource/erm2-nwe9.json?'+Rack::Utils.build_query({
    ...
    '$where' => <<-WHERE.oneline
      ...
      (complaint_type = 'HEAT/HOT WATER' OR complaint_type = 'Plumbing' OR complaint_type = 'Water Leak' OR complaint_type = 'UNSANITARY CONDITION' OR complaint_type = 'Electric' OR complaint_type = 'Dirty Conditions') AND
